...
// NOTES: in the current hytech.h, thr base CAN address for TTPMS is 0x424, not 0x406 like in the datasheet
// Has this been reprogrammed? Or should I also have a function for programming/setting the CAN ID (g 4 of datasheet)
// uses pre-existing structs and helper functions from hytech.h --> this matches datasheet specs on converting from
// CAN value to actual value
