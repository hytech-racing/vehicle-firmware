...
void setup()
{
    ...
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_1_MIN_ADDR, 2007); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_1_MAX_ADDR, 2569); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_2_MIN_ADDR, 1744); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_2_MAX_ADDR, 1170); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_2_MIN_ADDR, 2844); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_2_MAX_ADDR, 1379); //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_1_MIN_ADDR, 899);  //NOLINT manual pedals cal
    EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_1_MAX_ADDR, 2358); //NOLINT manual pedals cal
}
...
void loop()
{
    ...
    // pedal_sensor_data.accel_1 = ADCInterfaceInstance::instance().get_acceleration_1().raw;
    // pedal_sensor_data.accel_2 = ADCInterfaceInstance::instance().get_acceleration_2().raw;
    // pedal_sensor_data.brake_1 = ADCInterfaceInstance::instance().get_brake_1().raw;
    // pedal_sensor_data.brake_2 = ADCInterfaceInstance::instance().get_brake_2().raw;
    ...
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_1_MIN_ADDR, 1958);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_1_MAX_ADDR, 2505);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_2_MIN_ADDR, 1703);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::ACCEL_2_MAX_ADDR, 1143);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_1_MIN_ADDR, 2829);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_1_MAX_ADDR, 1950);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_2_MIN_ADDR, 837);
    //     EEPROMUtilities::write_eeprom_32bit(VCFSystems::BRAKE_2_MAX_ADDR, 1600);
    //     count = 0;
    // }
    // else {
    //     count++;
